...
public static class SeedData
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var existing in existingItems)
        {
            ...
            if (desired is not null
                && !string.IsNullOrWhiteSpace(desired.ImageUrl)
                && (string.IsNullOrWhiteSpace(existing.ImageUrl)
                    || existing.ImageUrl.Contains("source.unsplash.com", StringComparison.OrdinalIgnoreCase)))
            {
    ...
    private static List<MenuSeed> GetJuiceMenu() => new()
    {
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/desert-detox-elixir.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/immunity-boost-juice.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/vitality-hibiscus-elixir.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/tropical-hydration-juice.png"),
        ...
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/sunrise-papaya-mango-elixir.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/watermelon-mint-cooler.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/hacienda-citrus-medley.png"),
        new MenuSeed(
            ...
            15.99m,
            "/images/menu/golden-pineapple-ginger-shots.png"),
    };
    ...
    private static List<MenuSeed> GetComboMenu() => new()
    {
        new MenuSeed(
            ...
            22.99m,
            "/images/menu/sunrise-combo.png"),
        new MenuSeed(
            "Family Table Combo",
            "Two juices, two fruit salads, and four cookies for sharing.",
            44.99m,
            "/images/menu/family-table-combo.png"),
    };
    ...
    private static List<MenuSeed> GetSpecialOffersMenu() => new()
    {
        new MenuSeed(
            ...
            18.99m,
            "/images/menu/today-saver-pack.png"),
        new MenuSeed(
            "Weekend Fiesta Deal",
            "A vibrant weekend bundle with premium juice and sweet pairings.",
            24.99m,
            "/images/menu/weekend-fiesta-deal.png"),
    };
